...
{
  "$end", "error", "$undefined", "NOTE", "CHORD_TYPE", "DURATION",
  "$accept", "chord_sequence", "chord_item", 0
};
#endif
...
#line 42 "music.y"
    {
    if (!is_valid_chord((yyvsp[(1) - (3)].note), (yyvsp[(2) - (3)].chord_type))) {
        yyerror("Invalid chord in the scale");
    } else {
        play_sound_stretched((yyvsp[(1) - (3)].note), (yyvsp[(2) - (3)].chord_type), (yyvsp[(3) - (3)].duration));
    }
;}
    break;
